package com.gnivc.commonexception;

import com.gnivc.commonexception.exception.InvalidActionException;
...
public class ErrorHandler {
    @ExceptionHandler({InvalidValueException.class, InvalidActionException.class})
